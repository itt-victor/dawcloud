...
export const play = <HTMLInputElement>document.querySelector('#play-button'),
    record = <HTMLInputElement>document.querySelector('#record-button'),
    stop = <HTMLInputElement>document.querySelector('#stop-button'),
    cutButton = <HTMLInputElement>document.querySelector('#cut_function'),
    normalButton = <HTMLInputElement>document.querySelector('#normal_function'),
    is = { playing: false };
